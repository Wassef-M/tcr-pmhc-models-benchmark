...
RESULTS_DIRS = [
    INPUT_ROOT / "classI_v2_no_msa",
    INPUT_ROOT / "classI_v2_with_msa",
    INPUT_ROOT / "classI_v2_with_template",
    INPUT_ROOT / "classII_v2_no_msa",
    INPUT_ROOT / "classII_v2_with_msa",
    INPUT_ROOT / "classII_v2_with_template",
]
...
def get_class_name(result_dir: Path) -> str:
    if result_dir.name.startswith("classI"):
        return "classI"
    if result_dir.name.startswith("classII"):
        return "classII"
    if result_dir.name == "test_template_6zkw":
        return "classI"
...
def main():
    ...
    for result_dir in RESULTS_DIRS:
        ...
        for target_outer in target_dirs:
            ...
            summary_files = sorted(pred_dir.glob("*_summary_confidences.json"))
            ...
            for summary_file in summary_files:
                ...
                cif_path = pred_dir / f"{target_name}_seed-42_sample-{sample}.cif"
