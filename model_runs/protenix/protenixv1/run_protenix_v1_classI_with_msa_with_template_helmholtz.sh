...
INPUT_LIST="$PROJECT_DIR/json_list_re_run_with_msa_and_template.txt"
...
# Add bio-tools binaries to PATH
export PATH="$TOOLS_BIN:$PATH"

# Debug checks
echo "Kalign path: $(which kalign || true)"
echo "hmmsearch path: $(which hmmsearch || true)"
echo "hmmbuild path: $(which hmmbuild || true)"
...
OUTPUT_DIR="$PROJECT_DIR/results_with_template_re_run/$JSON_BASENAME"
mkdir -p "$OUTPUT_DIR"
