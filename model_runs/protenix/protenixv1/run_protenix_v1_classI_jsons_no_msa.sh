...
INPUT_DIR="$PROJECT_DIR/inputs/classI_jsons_protenix_without_msa"

RESULTS_DIR="$PROJECT_DIR/results/classI_protenix_v1_no_msa"
LOG_DIR="$PROJECT_DIR/logs/classI_protenix_v1_no_msa"
